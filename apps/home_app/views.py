    ...
    def get(self, request, *args, **kwargs):
        ...
        for data in matches_data:
            ...
            for key in temp_dict:  # list of dict
                temp_list.append(
                    {'id': count, 'year': key, 'matches_played': temp_dict[key]})
                count = count+1
...
class total_wins_per_team(APIView):
    def get(self, request, *args, **kwargs):
        ...
        for key in temp_dict:  # list of dict
            result_list.append(
                {'id': count, 'team': key, 'total_win': temp_dict[key]})
            count = count+1
    ...
    def get(self, request, *args, **kwargs):
        ...
        for year in year_list:
            ...
            for key in temp_dict:  # list of dict
                count = count+1
                result_list.append(
                    {'id': count, 'year': year, 'team': key, 'extra_run': temp_dict[key]})
...
class played_vs_win(APIView):
    def get(self, request, *args, **kwargs):
        ...
        for year in year_list:
            ...
            for key in temp_dict:  # list of dict
                count = count+1
                result_list.append({'id': count, 'year': year, 'team': key,
                                    'matches_played': temp_dict[key][0], 'matches_win': temp_dict[key][1]})
            #data for one year#
            # result_list.append(result_list_ii)  # data for every year
        return Response(result_list)
